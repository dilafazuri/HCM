...
<div class="container-fluid">
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            ...
            $query = mysqli_query($kon, "SELECT * FROM department") or die(mysqli_error($kon));
            $jumlah = mysqli_num_rows($query);

            echo "<a href='department_add.php' class='btn btn-info mb-3'>Input data baru disini</a><br>";
            if ($jumlah > 0) {
                echo '<table class="table table-bordered table-striped">';
                echo '<thead class="table-info"><tr><th>No</th><th>Department ID</th><th>Department Name</th><th>Ubah Data</th></tr></thead>';
                echo '<tbody>';
                $j = 0;
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo "<td><a href='department_delete.php?id=" . $row['department_id'] . "' class='btn btn-danger btn-sm'>Hapus</a> ";
                    echo "<a href='department_edit.php?id=" . $row['department_id'] . "' class='btn btn-warning btn-sm'>Edit</a></td>";
                    echo "</tr>";
                }
                echo '</tbody>';
                echo "</table>";
            } else {
                echo '<div class="alert alert-warning" role="alert">No department data found.</div>';
            }
            ?>
        </div>
    </div>
